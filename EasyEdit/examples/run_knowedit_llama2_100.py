...
if __name__ == "__main__":
    ...
    if args.ds_size is not None:
        args.pre_file = f"./{hparams.model_name.split('/')[-1]}_{args.datatype}_{args.ds_size}pre_edit_100.json"
    else:
        args.pre_file = f"./{hparams.model_name.split('/')[-1]}_{args.datatype}_pre_edit_100.json"
    print(args.pre_file)
    ...
    if args.save_model:
        ...
        try:
             save_model_path = f'{dir}{args.editing_method}_{args.datatype}_{hparams.model_name.split("/")[-1]}_{args.add2path}_stopcrit{hparams.stop_crit}_lr{hparams.lr}_cyc{hparams.cycles}_numsteps{hparams.num_steps}_layer{str(hparams.layers[0])}_results_100/'
        except:
             save_model_path = f'{dir}{args.editing_method}_{args.datatype}_{hparams.model_name.split("/")[-1]}_{args.add2path}_results_100/'
